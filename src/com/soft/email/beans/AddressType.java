...
/*
 * 
 * 			CREATE TABLE SM_TBLADDRESSTYPES
(
  AT_TYPEID					NUMBER(3)                  NOT NULL 			Primary Key,
  AT_TYPENAME				VARCHAR2(100 BYTE)    		DEFAULT (''),
  AT_ISFORINVOICE			NUMBER(1)					DEFAULT(0)			NOT NULL,
  AT_ISDISABLED				NUMBER(1)					DEFAULT(0)			NOT NULL,
...
public class AddressType {
	    ...
	    public AddressType(int id, String name, int invoice , int disable, long SU_SysUserID, String SU_SysUserIP, String SU_InsertDate, long SU_SysUserIDM, String SU_SysUserIPM, String SU_ModifyDate)
	    {
	    	this.TypeID = id;
	    	if(name == null)name="";
	    	this.TypeName = name;	
	    	this.isForinvoice=invoice;
	    ...
	    public int getisForinvoice(){
	    	return isForinvoice;
	    }
	    public void setisForinvoice(int isForinvoice){
