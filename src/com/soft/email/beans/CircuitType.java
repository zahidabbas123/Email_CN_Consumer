...
/*
 * 
 * 			CREATE TABLE TERMINUSBILL.SM_TBLCIRCUITTYPES
(
  CIRT_TYPEID      NUMBER(3)                    NOT NULL,
  CIRT_TYPENAME    VARCHAR2(100 BYTE)           DEFAULT '',
  CIRT_ISDISABLED  NUMBER(1)                    DEFAULT (0)                   NOT NULL,
...
public class CircuitType {
	    ...
	    public CircuitType(int id, String name, int disable, long SU_SysUserID, String SU_SysUserIP, String SU_InsertDate, long SU_SysUserIDM, String SU_SysUserIPM, String SU_ModifyDate)
	    {
	    	this.TypeID = id;
	    	if(name == null)name="";
	    	this.TypeName = name;	
