...
/*
 * 
 * 			CREATE TABLE TERMINUSBILL.SM_TBLCUSTOMERTYPES
(
  CT_TYPEID      NUMBER(5)                      NOT NULL,
  CT_TYPENAME    VARCHAR2(100 BYTE)             DEFAULT '',
  CT_TYPEDESC    VARCHAR2(200 BYTE)             DEFAULT '',
  CT_ISDISABLED  NUMBER(1)                      DEFAULT (0)                   NOT NULL,
...
public class CustomerType {
	    ...
	    public CustomerType(int id, String name, String desc,int isforall,int iscorporate, int disable, long SU_SysUserID, String SU_SysUserIP, String SU_InsertDate, long SU_SysUserIDM, String SU_SysUserIPM, String SU_ModifyDate)
	    {
	    	this.TypeID = id;
	    	if(name == null)name="";
	    	this.TypeName = name;	
	    ...
	    public void setisForAll(int isForAll){
	        this.isForAll = isForAll;
	    }
	        
	    public int getisCorporat(){
	    	return isCorporate;
	    }
	    public void setisCorporat(int isCorporate){
	        this.isCorporate = isCorporate;
	    }
