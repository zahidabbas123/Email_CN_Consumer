...
public class ExpireServiceAlert {
		...
		String SS_EXPIRYDATE;
		String DSLNO;
		
		
	    public ExpireServiceAlert() {
	    ...
	    public String getSS_EXPIRYDATE() {
	        return SS_EXPIRYDATE;
	    }
	    public void setSS_EXPIRYDATE(String SS_EXPIRYDATE) {
	        this.SS_EXPIRYDATE = SS_EXPIRYDATE;
	    }
