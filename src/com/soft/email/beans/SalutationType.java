...
/*
 * 
 * 			CREATE TABLE SM_TBLSALUTATIONTYPES
(
  ST_TYPEID     		NUMBER(3)                    		Primary Key,
  ST_TYPENAME   		VARCHAR2(100 BYTE)          DEFAULT '' ,
  ST_TYPECODE   		VARCHAR2(25 BYTE)          	DEFAULT '' ,
...
public class SalutationType {
	    ...
	    public SalutationType(int id, String name, String code, int disable, long SU_SysUserID, String SU_SysUserIP, String SU_InsertDate, long SU_SysUserIDM, String SU_SysUserIPM, String SU_ModifyDate)
	    {
	    	this.TypeID = id;
	    	if(name == null)name="";
	    	this.TypeName = name;	
