...
/*
 * 
 * 			CREATE TABLE TERMINUSBILL.SM_TBLSVEFINTYPE
(
  SFT_TYPEID        NUMBER(3)                   NOT NULL,
  SFT_TYPENAME      VARCHAR2(100 BYTE)          DEFAULT '',
  SFT_ISCHARGEABLE  NUMBER(1)                   DEFAULT (0)                   NOT NULL,
  SFT_ISDISABLED    NUMBER(1)                   DEFAULT (0)                   NOT NULL,
...
public class SveFinType{
	    ...
	    public SveFinType(int id, String name, int isChargeable, int disable, long SU_SysUserID, String SU_SysUserIP, String SU_InsertDate, long SU_SysUserIDM, String SU_SysUserIPM, String SU_ModifyDate)
	    {
	    	this.TypeID = id;
	    	if(name == null)name="";
	    	this.TypeName = name;	
