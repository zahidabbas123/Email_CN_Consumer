...
/*
 * 
 * 			CREATE TABLE SER_TBLSVSBLKPOLICIES(
  SBP_POLICYID           NUMBER(10)                             NOT NULL                                 PRIMARY KEY,
  SBP_NAME                VARCHAR2(30 BYTE)                DEFAULT (''),
  SBP_ISPREPAID                    NUMBER(1)                              DEFAULT (0)                             NOT NULL,
  SBP_ISDISABLED                              NUMBER(1)                              DEFAULT (0)                             NOT NULL,
...
public class SvsBlkPolicy {
	    ...
	    public SvsBlkPolicy(int PolicyID, String Name, int isPrepaid, int disable, long SU_SysUserID, String SU_SysUserIP, String SU_InsertDate, long SU_SysUserIDM, String SU_SysUserIPM, String SU_ModifyDate)
	    {
