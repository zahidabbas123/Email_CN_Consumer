...
<txt:block linesAfter="1"> You have received a new reply against the Trouble Ticket ID: <xsl:value-of
       select="ticketid"/> and Reply Details are : <xsl:value-of select="details"/>
</txt:block>
</xsl:template>
